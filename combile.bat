...
gcc -I includes/ -o bin/libmodbus.dll -s -shared src/modbus.c src/modbus-rtu.c src/modbus-tcp.c src/modbus-data.c -lws2_32 -D DLLBUILD
...
gcc -I includes/ -o bin/liberror-modalo.dll -s -shared src/modaloError.c -D MODALO_EXPORT
